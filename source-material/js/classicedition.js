...
communityChestCards[0] = new Card("Get out of Jail, Free. This card may be kept until needed or sold.", function(p) { p.communityChestJailCard = true;
    updateOwned(); });
...
communityChestCards[12] = new Card("Opera. Collect $10 from every player.", function() { collectfromeachplayer(10, 'Community Chest'); });
...
chanceCards[0] = new Card("GET OUT OF JAIL FREE. This card may be kept until needed or traded.", function(p) { p.chanceJailCard = true;
    updateOwned(); });
...
chanceCards[2] = new Card("Advance to \"GO\" (Collect $200).", function() { advance(0); });
...
xchanceCards[2] = new Card("Speeding fine $15.", function() { subtractamount(15, 'Chance'); });