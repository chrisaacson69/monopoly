function Game() {
    ...
    this.bankruptcy = function() {
        ...
        if (pcount === 2 || bankruptcyUnmortgageFee === 0 || p.creditor === 0) {
            ...
            popup("<p>" + pcredit.name + ", you must pay $" + bankruptcyUnmortgageFee + " interest on the mortgaged properties you received from " + p.name + ".</p>", function() { player[pcredit.index].pay(bankruptcyUnmortgageFee, 0);
